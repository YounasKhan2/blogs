...
export default function TechReviews() {
  const allPosts = [
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1484704849700-f032a568e944?w=400&h=300&fit=crop&auto=format&q=80",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=400&h=300&fit=crop&auto=format&q=80",
